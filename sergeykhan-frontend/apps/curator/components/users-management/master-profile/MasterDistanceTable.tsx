...
const MasterDistanceTable: React.FC<MasterDistanceTableProps> = ({ masterId }) => {
  ...
  const { loading, error, fetchMasterDistanceInfo } = useDistanceApi();
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Текущий уровень видимости: {distanceInfo.distance_level_name} ({distanceInfo.manual_override ? "установлен вручную" : "автоматический"})
            </CardDescription>
          </div>
          ...
          <div className="mt-6">
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Дистанционка настраивается автоматически на основе показателей мастера. 
                Изменить уровень дистанционки вручную может только супер-администратор.
              </p>
            </div>
          </div>
        </div>
