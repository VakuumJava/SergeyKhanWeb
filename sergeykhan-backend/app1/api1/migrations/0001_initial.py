    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('обзвонен',
                                            'Обзвонен'),
                                           ('не обзвонен',
                                            'Не обзвонен')],
                                  default='не обзвонен',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role',
                 models.CharField(choices=[('master',
                                            'Мастер'),
                                           ('operator',
                                            'Оператор'),
                                           ('warrant-master',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('balance_type',
                 models.CharField(choices=[('current',
                                            'Текущий баланс'),
                                           ('paid',
                                            'Выплаченная сумма')],
                                  default='current',
                ...
                ('action_type', models.CharField(choices=[
                 ('top_up', 'Пополнение'), ('deduct', 'Списание')], default='top_up', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(blank=True,
                 max_length=255, null=True, verbose_name='Улица')),
                ('house_number', models.CharField(blank=True,
                 max_length=50, null=True, verbose_name='Номер дома')),
                ('apartment', models.CharField(blank=True,
                 max_length=50, null=True, verbose_name='Квартира')),
                ('entrance', models.CharField(blank=True,
                 max_length=50, null=True, verbose_name='Подъезд')),
                ('address', models.CharField(blank=True, max_length=255, null=True)),
                ('status',
                 models.CharField(choices=[('новый',
                                            'Новый'),
                                           ('в обработке',
                                            'В обработке'),
                                           ('назначен',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance_percent', models.PositiveIntegerField(
                    default=30, help_text='Аванс мастеру (% от чистой прибыли)')),
                ('initial_kassa_percent', models.PositiveIntegerField(
                    default=70, help_text='Сумма для передачи в кассу (% от чистой прибыли)')),
                ('cash_percent', models.PositiveIntegerField(default=30,
                 help_text='Наличные мастеру сразу (% от общей суммы)')),
                ('balance_percent', models.PositiveIntegerField(default=30,
                 help_text='Зачисление на баланс мастеру (% от общей суммы)')),
                ('curator_percent', models.PositiveIntegerField(
                    default=5, help_text='Зарплата куратору (% от общей суммы)')),
                ('final_kassa_percent', models.PositiveIntegerField(
                    default=35, help_text='Касса компании (% от общей суммы)')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('updated_by',
                 models.ForeignKey(blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type',
                 models.CharField(choices=[('balance_top_up',
                                            'Пополнение баланса'),
                                           ('balance_deduct',
                                            'Списание с баланса'),
                                           ('paid_amount_top_up',
                                            'Пополнение выплаченной суммы'),
                                           ('paid_amount_deduct',
                                            'Списание с выплаченной суммы'),
                                           ('profit_distribution',
                ...
                ('order', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.SET_NULL, to='api1.order')),
                ('performed_by',
                 models.ForeignKey(null=True,
                                   on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('master',
                 models.ForeignKey(limit_choices_to={'role': 'master'},
